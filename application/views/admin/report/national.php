                        ...
                        <form method='GET' action="<?php echo base_url('admin/report/newbornweek'); ?>">
                            <div class="row">                                                               
                                <div class="col-md-4">
                                    ...
                                    <div class="col-md-4">
                                <div style="margin-top: 30px;"><button class="btn btn-success pull-right " id="btnExport" value="Export" onclick="Export()"><i class="fa fa-file-excel-o"></i> Export to Excel</button> </div>
                                </div>
                            </div>
                        </form>
                    </div>
							...
							<table class="table table-bordered table_download" cellpadding="7">
								  ...
								  <?php }else { ?>
									...
									<?php } ?>
                                     <tr>
                                        ...
                                        <th rowspan="2">District Count</th>
										<?php if($newbornweek_eventdate_id) { ?>
								...
								foreach ($data_rows as $rows) { ?>
									<tr>
										<td><?php echo $i++; ?></td>
										<td>
										  <a href="<?php echo base_url(); ?>admin/report/newbornweek/?State_ID=<?php echo  $rows['State_ID']; ?>&newbornweek_eventdate_id=<?php echo  $newbornweek_eventdate_id; ?>"> 
											 <?php echo $rows['State_Name']; ?> 
										   </a>
										</td>
										<td><?php echo $rows['district_count']; $total_district_count += $rows['district_count']?></td>
										<?php if($newbornweek_eventdate_id) { ?>
								...
								<?php } ?>
									<tr>
										...
										<td><b><?php echo $total_district_count; ?></b></td>
										<?php if($newbornweek_eventdate_id) { ?>
