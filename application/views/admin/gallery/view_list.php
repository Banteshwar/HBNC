                                ...
                                <tbody>
                                    ...
                                    foreach ($result_list as $row) {
                                        ...
                                        <tr>
                                            ...
                                            <td><a href="<?php echo base_url('download/gallery/' . $row['image']); ?>" class="fancybox"><img id="myImg" src="<?php echo base_url('download/gallery/' . $row['image']); ?>" class="img-responsive" width="75px" height="75px"></a>
                                            </td>
                                            ...
                                            <td>                                             
                                                ...
                                                <a href="<?php echo base_url('admin/gallery/EditGallery'); ?>?action=edit&id=<?php echo $row['id']; ?>" class="btn btn-primary btn-sm"><i class="fa fa-pencil"></i></a>


                                                &nbsp;&nbsp;											
                                                <a href="<?php echo base_url('admin/gallery/deleteGallery'); ?>?id=<?php echo $row['id']; ?>" class="btn btn-danger btn-sm" onclick="return confirm('Are you sure?')"><i class="fa fa-trash-o"></i></a>	&nbsp;&nbsp;	
                    ...
                    <div class="table-responsive">
                        <table class="table table-bordered">
                            ...
                            <tbody>
                                <tr>
                                    <th>Full Name</th>
                                    <td><input type="text" name="fname" class="form-control fname" id="fname"/></td>
                                </tr>
                                <tr>
                                    <th>Role</th>
                                    <td>
                                        <select class="form-control" id="roleIDAjax">
                                            <option value="0">Select Role</option>
                <?php foreach ($roles as $roleVal) { ?>

                                                <option value="<?php if(isset($roleVal->id))echo $roleVal->id; ?>" <?php if(isset($roleVal->id))echo set_select('role_name', $roleVal->id); ?>><?php if(isset($roleVal->id))echo $roleVal->role; ?></option>
...
<?php } ?>
                                ...
                                <tr>
                                    <th>State</th>
                                    <td>
                                        <select class="form-control" id="stateIDAjax">
                                            <option value ="0" >Select State</option>

<?php foreach ($states as $stateVal) { ?>

                                                <option value="<?php echo $stateVal['State_ID']; ?>" required=""><?php if(isset( $stateVal['State_Name']))echo $stateVal['State_Name']; ?></option>
...
<?php } ?>
                                ...
                                <tr>
                                    <th>District</th>
                                    <td>
                                        <select class="form-control" id="districtIDAjax">
                                            <!--<option value ="0" >Select District</option>-->
<?php //foreach($districts as $distVal) {  ?>

                                                    <!--<option value="<?php //echo $distVal['district_ID'];?>" required=""><?php //echo $distVal['district_name'];?></option>-->
...
<?php //}  ?>
                                ...
                                <tr>
                                    <th>User Mobile No.</th>
                                    <td><input type="text" class="form-control mobile" id="phone" /></td>
                                </tr>
                                <tr>
                                    <th>Email</th>
                                    <td><input type="email" class="form-control email" disabled="" /></td>
                                ...
                                <tr>
                                    ...
                                    <td>
                                        <input type="radio" name="active" value="1" class="sttaus">Active 
                                        <input type="radio" name="active" value="0" class="sttaus">InActive</td>
